...
public class VideoActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		overridePendingTransition(ru.krasview.tv_site.R.anim.anim_enter_right, ru.krasview.tv_site.R.anim.anim_leave_left);
	 ...
	 private static class VideoPlayerHandler extends Handler{
	   ...
	   public void onBackPressed(){
		   Intent intent = new Intent();
		    ...
		    super.onBackPressed();
		    overridePendingTransition(ru.krasview.tv_site.R.anim.anim_enter_left, ru.krasview.tv_site.R.anim.anim_leave_right);
	   }
