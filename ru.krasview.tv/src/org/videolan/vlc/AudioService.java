    ...
    private void showNotification() {
        try {
            ...
            if (Util.isJellyBeanOrLater()) {
                ...
                view.setImageViewResource(R.id.play_pause, mLibVLC.isPlaying() ? R.drawable.ic_new_pause : R.drawable.ic_new_play);
                ...
                view_expanded.setImageViewResource(R.id.play_pause, mLibVLC.isPlaying() ? R.drawable.ic_new_pause : R.drawable.ic_new_play);
